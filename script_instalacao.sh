...
show_status "Instalando Node.js 18.x"
curl -fsSL https://deb.nodesource.com/setup_16.x | bash - || show_error "Falha ao adicionar repositório Node.js"
apt install -y nodejs || show_error "Falha ao instalar Node.js"
